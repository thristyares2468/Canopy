        ...
        {section === 'advanced' && <div className="settings-groups">
          ...
          <details className="internal-pages">
            ...
            <div className="internal-content">
              ...
              <p className="internal-note">Canopy opens the hosted game directly so login and multiplayer use the same secure Railway connection as the public site.</p>
            </div>
          </details>
        </div>}
      </div>
...
export default function App() {
  ...
  const launchGame = async () => {
    if (!api) return;
    setGameStatus({ state: 'starting', message: "Connecting to Jim's Mowing…" });
